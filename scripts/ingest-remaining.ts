...
// Files already ingested (from previous session)
const ALREADY_PROCESSED = new Set([
  '1a0c0297-fa4a-5e63-8dc7-4e0155fb0190.pdf',
  'rulings/LAT_2017_Balandžio.pdf',
  'rulings/LAT_2017_Birželio.pdf',
  'rulings/LAT_2017_Gegužės.pdf',
  'rulings/LAT_2017_Gruodžio.pdf',
  'rulings/LAT_2017_Kovo.pdf',
  'rulings/LAT_2017_Lapkričio.pdf',
  'rulings/LAT_2017_Liepos-rugpjūčio.pdf',
  'rulings/LAT_2017_Rugsėjo.pdf',
  'rulings/LAT_2017_Sausio.pdf',
  'rulings/LAT_2017_Spalio.pdf',
  'rulings/LAT_2017_Vasario.pdf',
  'rulings/LAT_2018_Balandžio.pdf',
  'rulings/LAT_2018_Birželio.pdf',
  'rulings/LAT_2018_Gegužės.pdf',
  'rulings/LAT_2018_Gruodžio.pdf',
  'rulings/LAT_2018_Kovo.pdf',
  'rulings/LAT_2018_Lapkričio.pdf',
  'rulings/LAT_2018_Liepos-rugpjūčio.pdf',
  'rulings/LAT_2018_Rugsėjo.pdf',
  'rulings/LAT_2018_Sausio.pdf',
  'rulings/LAT_2018_Spalio.pdf',
  'rulings/LAT_2018_Vasario.pdf',
  'rulings/LAT_2019_Balandžio.pdf',
  'rulings/LAT_2019_Birželio.pdf',
  'rulings/LAT_2019_Gegužės.pdf',
]);
...
async function ingestDocuments() {
  console.log('Starting ingestion of remaining files...\n');

  const index = pinecone.index(INDEX_NAME);

  // Get all PDF files and filter out already processed
  const allFiles = getPdfFiles(DATA_DIR);
  const pdfFiles = allFiles.filter(f => !ALREADY_PROCESSED.has(f));
  console.log(`Files to process: ${pdfFiles.length} (skipping ${allFiles.length - pdfFiles.length} already done)\n`);
